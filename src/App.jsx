...
export default function App() {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(doc(db, "pharmacy", "schedule"), (snap) => {
      ...
      {
        const RESTORE_KEY = "schedule_restored_v6";
          ...
          {empTab==="schedule" && currentWeekPublished && (
            <div style={{marginTop:4}}>
              ...
              <div style={{display:"flex",gap:8,marginTop:10}}>
                ...
                <button style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",gap:7,padding:11,borderRadius:10,border:"none",fontSize:13,fontWeight:"500",cursor:"pointer",background:"#1D9E75",color:"#fff"}}
                  onClick={()=>{
